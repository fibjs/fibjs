...
public:
    ...
    const char *LocalTimezone(int64_t time_ms)
    {
        ...
        return v8::internal::OS::LocalTimezone(static_cast<double>(time_ms));
    }
    ...
    virtual int GetDaylightSavingsOffsetFromOS(int64_t time_sec)
    {
        ...
        return static_cast<int>(v8::internal::OS::DaylightSavingsOffset(time_ms));
    }

    virtual int GetLocalOffsetFromOS()
    {
        double offset = v8::internal::OS::LocalTimeOffset();
