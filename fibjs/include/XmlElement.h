...
public:
    ...
    virtual result_t getAttribute(const char *name, exlib::string &retVal);
    virtual result_t getAttributeNS(const char *namespaceURI, const char *localName, exlib::string &retVal);
...
public:
    ...
    void fix_prefix(const char *namespaceURI, exlib::string &prefix);
