...
public:
    ...
    virtual result_t get_progressive(bool& retVal);
    virtual result_t set_progressive(bool newVal);
    virtual result_t get_alphaBlending(bool &retVal);
    virtual result_t set_alphaBlending(bool newVal);
    virtual result_t getData(int32_t format, int32_t quality, obj_ptr<Buffer_base> &retVal, AsyncEvent *ac);
    virtual result_t save(Stream_base *stm, int32_t format, int32_t quality, AsyncEvent *ac);
    virtual result_t save(exlib::string fname, int32_t format, int32_t quality, AsyncEvent *ac);
    virtual result_t colorAllocate(int32_t red, int32_t green, int32_t blue, int32_t &retVal);
    virtual result_t colorAllocate(int32_t color, int32_t &retVal);
    virtual result_t colorAllocateAlpha(int32_t red, int32_t green, int32_t blue, double alpha, int32_t &retVal);
    virtual result_t colorAllocateAlpha(int32_t color, int32_t &retVal);
    virtual result_t colorClosest(int32_t red, int32_t green, int32_t blue, int32_t &retVal);
    virtual result_t colorClosest(int32_t color, int32_t &retVal);
    virtual result_t colorClosestHWB(int32_t red, int32_t green, int32_t blue, int32_t &retVal);
    virtual result_t colorClosestHWB(int32_t color, int32_t &retVal);
    virtual result_t colorClosestAlpha(int32_t red, int32_t green, int32_t blue, double alpha, int32_t &retVal);
    virtual result_t colorClosestAlpha(int32_t color, int32_t &retVal);
    virtual result_t colorExact(int32_t red, int32_t green, int32_t blue, int32_t &retVal);
    virtual result_t colorExact(int32_t color, int32_t &retVal);
    virtual result_t colorExactAlpha(int32_t red, int32_t green, int32_t blue, double alpha, int32_t &retVal);
    virtual result_t colorExactAlpha(int32_t color, int32_t &retVal);
    virtual result_t colorResolve(int32_t red, int32_t green, int32_t blue, int32_t &retVal);
    virtual result_t colorResolve(int32_t color, int32_t &retVal);
    virtual result_t colorResolveAlpha(int32_t red, int32_t green, int32_t blue, double alpha, int32_t &retVal);
    virtual result_t colorResolveAlpha(int32_t color, int32_t &retVal);
    ...
    virtual result_t colorReplace(int32_t src, int32_t dst, AsyncEvent *ac);
    virtual result_t clone(obj_ptr<Image_base> &retVal, AsyncEvent *ac);
    virtual result_t resample(int32_t width, int32_t height, obj_ptr<Image_base> &retVal, AsyncEvent *ac);
    virtual result_t crop(int32_t x, int32_t y, int32_t width, int32_t height, obj_ptr<Image_base> &retVal, AsyncEvent *ac);
    virtual result_t flip(int32_t dir, AsyncEvent *ac);
    virtual result_t rotate(int32_t dir, AsyncEvent *ac);
    virtual result_t convert(int32_t color, AsyncEvent *ac);
    virtual result_t copy(Image_base *source, int32_t dstX, int32_t dstY, int32_t srcX, int32_t srcY, int32_t width, int32_t height, AsyncEvent *ac);
    virtual result_t copyMerge(Image_base *source, int32_t dstX, int32_t dstY, int32_t srcX, int32_t srcY, int32_t width, int32_t height, int32_t percent, AsyncEvent *ac);
    virtual result_t copyMergeGray(Image_base *source, int32_t dstX, int32_t dstY, int32_t srcX, int32_t srcY, int32_t width, int32_t height, int32_t percent, AsyncEvent *ac);
    virtual result_t copyResized(Image_base *source, int32_t dstX, int32_t dstY, int32_t srcX, int32_t srcY, int32_t dstW, int32_t dstH, int32_t srcW, int32_t srcH, AsyncEvent *ac);
...
private:
    ...
    void setExtMemory(int32_t add = 1);
