...
public:
    ...
    virtual result_t equal(int64_t num, bool &retVal);
    virtual result_t equal(Int64_base *num, bool &retVal);
    virtual result_t compare(int64_t num, int32_t &retVal);
    ...
    virtual result_t _and(int64_t num, obj_ptr<Int64_base> &retVal);
    virtual result_t _and(Int64_base *num, obj_ptr<Int64_base> &retVal);
    virtual result_t _or(int64_t num, obj_ptr<Int64_base> &retVal);
    virtual result_t _or(Int64_base *num, obj_ptr<Int64_base> &retVal);
    virtual result_t _xor(int64_t num, obj_ptr<Int64_base> &retVal);
    virtual result_t _xor(Int64_base *num, obj_ptr<Int64_base> &retVal);
    virtual result_t add(int64_t num, obj_ptr<Int64_base> &retVal);
    virtual result_t add(Int64_base *num, obj_ptr<Int64_base> &retVal);
    virtual result_t sub(int64_t num, obj_ptr<Int64_base> &retVal);
