...
public:
    ...
    virtual result_t readUInt32LE(int32_t offset, int64_t& retVal);
    virtual result_t readUInt32BE(int32_t offset, int64_t& retVal);
    virtual result_t readUIntLE(int32_t offset, int32_t byteLength, int64_t& retVal);
    virtual result_t readUIntBE(int32_t offset, int32_t byteLength, int64_t& retVal);
    ...
    virtual result_t readIntLE(int32_t offset, int32_t byteLength, int64_t& retVal);
    virtual result_t readIntBE(int32_t offset, int32_t byteLength, int64_t& retVal);
