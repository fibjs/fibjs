...
public:
    ...
    virtual result_t indexOf(int32_t value, v8::Local<v8::Value> offset, exlib::string encoding, int32_t& retVal);
    virtual result_t indexOf(exlib::string v, v8::Local<v8::Value> offset, exlib::string encoding, int32_t& retVal);
    virtual result_t indexOf(Buffer_base* v, v8::Local<v8::Value> offset, exlib::string encoding, int32_t& retVal);
    ...
    virtual result_t writeUIntLE(int64_t value, int32_t offset, bool noAssert, int32_t& retVal);
    virtual result_t writeUIntBE(int64_t value, int32_t offset, bool noAssert, int32_t& retVal);
