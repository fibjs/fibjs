...
public:
    ...
    static result_t load(v8::Local<v8::Value> v, obj_ptr<StringDecoder_base>& retVal);
...
inline result_t StringDecoder_base::load(v8::Local<v8::Value> v, obj_ptr<StringDecoder_base>& retVal)
{
    obj_ptr<StringDecoder_base> vr;
