...
public:
    ...
    static result_t load(v8::Local<v8::Value> v, obj_ptr<HttpServer_base>& retVal);
...
inline result_t HttpServer_base::load(v8::Local<v8::Value> v, obj_ptr<HttpServer_base>& retVal)
{
    obj_ptr<HttpServer_base> vr;
...
inline void HttpServer_base::s_get_maxHeadersCount(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    int32_t vr;
...
inline void HttpServer_base::s_set_maxHeadersCount(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    METHOD_INSTANCE(HttpServer_base);
    METHOD_ENTER();
...
inline void HttpServer_base::s_get_maxHeaderSize(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    int32_t vr;
...
inline void HttpServer_base::s_set_maxHeaderSize(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    METHOD_INSTANCE(HttpServer_base);
    METHOD_ENTER();
...
inline void HttpServer_base::s_get_maxBodySize(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    int32_t vr;
...
inline void HttpServer_base::s_set_maxBodySize(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    METHOD_INSTANCE(HttpServer_base);
    METHOD_ENTER();
...
inline void HttpServer_base::s_get_enableEncoding(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    bool vr;
...
inline void HttpServer_base::s_set_enableEncoding(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    METHOD_INSTANCE(HttpServer_base);
    METHOD_ENTER();
...
inline void HttpServer_base::s_get_serverName(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    exlib::string vr;
...
inline void HttpServer_base::s_set_serverName(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    METHOD_INSTANCE(HttpServer_base);
    METHOD_ENTER();
