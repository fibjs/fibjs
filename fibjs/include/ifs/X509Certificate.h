...
public:
    ...
    static result_t load(v8::Local<v8::Value> v, obj_ptr<X509Certificate_base>& retVal);
...
inline result_t X509Certificate_base::load(v8::Local<v8::Value> v, obj_ptr<X509Certificate_base>& retVal)
{
    obj_ptr<X509Certificate_base> vr;
