...
public:
    ...
    static result_t load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<X509Certificate_base>& retVal);
...
inline void X509Certificate_base::__new(const v8::FunctionCallbackInfo<v8::Value>& args)
{
...
inline result_t X509Certificate_base::load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<X509Certificate_base>& retVal)
{
    obj_ptr<X509Certificate_base> vr;
