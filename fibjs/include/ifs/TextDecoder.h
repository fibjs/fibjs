...
public:
    ...
    static result_t load(v8::Local<v8::Value> v, obj_ptr<TextDecoder_base>& retVal);
...
inline result_t TextDecoder_base::load(v8::Local<v8::Value> v, obj_ptr<TextDecoder_base>& retVal)
{
    obj_ptr<TextDecoder_base> vr;
