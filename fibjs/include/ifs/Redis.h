...
inline ClassInfo& Redis_base::class_info()
{
    static ClassData::ClassMethod s_method[] = {
        { "command", s_command, false, false },
        { "set", s_set, false, false },
        { "setNX", s_setNX, false, false },
        { "setXX", s_setXX, false, false },
        { "mset", s_mset, false, false },
        { "msetNX", s_msetNX, false, false },
        { "append", s_append, false, false },
        { "setRange", s_setRange, false, false },
        { "getRange", s_getRange, false, false },
        { "strlen", s_strlen, false, false },
        { "bitcount", s_bitcount, false, false },
        { "get", s_get, false, false },
        { "mget", s_mget, false, false },
        { "getset", s_getset, false, false },
        { "decr", s_decr, false, false },
        { "incr", s_incr, false, false },
        { "setBit", s_setBit, false, false },
        { "getBit", s_getBit, false, false },
        { "exists", s_exists, false, false },
        { "type", s_type, false, false },
        { "keys", s_keys, false, false },
        { "del", s_del, false, false },
        { "expire", s_expire, false, false },
        { "ttl", s_ttl, false, false },
        { "persist", s_persist, false, false },
        { "rename", s_rename, false, false },
        { "renameNX", s_renameNX, false, false },
        { "sub", s_sub, false, false },
        { "unsub", s_unsub, false, false },
        { "psub", s_psub, false, false },
        { "unpsub", s_unpsub, false, false },
        { "pub", s_pub, false, false },
        { "getHash", s_getHash, false, false },
        { "getList", s_getList, false, false },
        { "getSet", s_getSet, false, false },
        { "getSortedSet", s_getSortedSet, false, false },
        { "dump", s_dump, false, false },
        { "restore", s_restore, false, false },
