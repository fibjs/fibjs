...
namespace fibjs
{
    ...
    inline void Trigger_base::s_addListener(const v8::FunctionCallbackInfo<v8::Value>& args)
    {
        int32_t vr;
    ...
    inline void Trigger_base::s_removeListener(const v8::FunctionCallbackInfo<v8::Value>& args)
    {
        int32_t vr;
    ...
    inline void Trigger_base::s_removeAllListeners(const v8::FunctionCallbackInfo<v8::Value>& args)
    {
        int32_t vr;
    ...
    inline void Trigger_base::s_listeners(const v8::FunctionCallbackInfo<v8::Value>& args)
    {
