...
public:
    ...
    static result_t load(v8::Local<v8::Value> v, obj_ptr<WebSocketMessage_base>& retVal);
...
inline result_t WebSocketMessage_base::load(v8::Local<v8::Value> v, obj_ptr<WebSocketMessage_base>& retVal)
{
    obj_ptr<WebSocketMessage_base> vr;
