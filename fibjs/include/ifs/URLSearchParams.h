...
public:
    ...
    static result_t load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<URLSearchParams_base>& retVal);
...
inline result_t URLSearchParams_base::load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<URLSearchParams_base>& retVal)
{
    obj_ptr<URLSearchParams_base> vr;
