...
public:
    ...
    static result_t load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<base32_base>& retVal)
...
inline void base32_base::s_static_encode(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    exlib::string vr;
...
inline void base32_base::s_static_decode(const v8::FunctionCallbackInfo<v8::Value>& args)
{
