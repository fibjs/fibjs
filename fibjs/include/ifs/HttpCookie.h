...
public:
    ...
    static result_t load(v8::Local<v8::Value> v, obj_ptr<HttpCookie_base>& retVal);
...
inline result_t HttpCookie_base::load(v8::Local<v8::Value> v, obj_ptr<HttpCookie_base>& retVal)
{
    obj_ptr<HttpCookie_base> vr;
