...
public:
    ...
    static result_t load(v8::Local<v8::Value> v, obj_ptr<child_process_base>& retVal)
...
inline void child_process_base::s_static_exec(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    ASYNC_METHOD_ENTER("child_process.exec");
...
inline void child_process_base::s_static_execFile(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    ASYNC_METHOD_ENTER("child_process.execFile");
...
inline void child_process_base::s_static_run(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    ASYNC_METHOD_ENTER("child_process.run");
...
inline void child_process_base::s_static_sh(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    ASYNC_METHOD_ENTER("child_process.sh");
