...
inline void path_posix_base::s_normalize(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    exlib::string vr;

    METHOD_ENTER("path_posix.normalize");
...
inline void path_posix_base::s_basename(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    exlib::string vr;

    METHOD_ENTER("path_posix.basename");
...
inline void path_posix_base::s_extname(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    exlib::string vr;

    METHOD_ENTER("path_posix.extname");
...
inline void path_posix_base::s_dirname(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    exlib::string vr;

    METHOD_ENTER("path_posix.dirname");
...
inline void path_posix_base::s_fullpath(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    exlib::string vr;

    METHOD_ENTER("path_posix.fullpath");
...
inline void path_posix_base::s_isAbsolute(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    METHOD_ENTER("path_posix.isAbsolute");
...
inline void path_posix_base::s_resolve(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    exlib::string vr;

    METHOD_ENTER("path_posix.resolve");
...
inline void path_posix_base::s_get_delimiter(v8::Local<v8::String> property, const v8::PropertyCallbackInfo<v8::Value>& args)
{
    ...
    PROPERTY_ENTER("path_posix.delimiter");
...
inline void path_posix_base::s_get_posix(v8::Local<v8::String> property, const v8::PropertyCallbackInfo<v8::Value>& args)
{
    ...
    PROPERTY_ENTER("path_posix.posix");
...
inline void path_posix_base::s_get_win32(v8::Local<v8::String> property, const v8::PropertyCallbackInfo<v8::Value>& args)
{
    ...
    PROPERTY_ENTER("path_posix.win32");
