...
inline void RadosStream_base::s_get_key(v8::Local<v8::Name> property, const v8::PropertyCallbackInfo<v8::Value>& args)
{
    exlib::string vr;

    METHOD_NAME("RadosStream.key");
...
inline void RadosStream_base::s_radosStat(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    METHOD_NAME("RadosStream.radosStat");
    METHOD_INSTANCE(RadosStream_base);
    METHOD_ENTER();
...
{
    METHOD_NAME("RadosStream.writeFull");
    METHOD_INSTANCE(RadosStream_base);
    METHOD_ENTER();
...
{
    METHOD_NAME("RadosStream.append");
    METHOD_INSTANCE(RadosStream_base);
    METHOD_ENTER();
