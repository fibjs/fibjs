...
public:
    ...
    virtual result_t get_childsCount(int32_t& retVal) = 0;
...
public:
    ...
    static void s_get_childsCount(v8::Local<v8::String> property, const v8::PropertyCallbackInfo<v8::Value> &args);
...
namespace fibjs
{
    inline ClassInfo& HeapGraphNode_base::class_info()
    {
        static ClassData::ClassProperty s_property[] = 
        {
            ...
            {"childsCount", s_get_childsCount, block_set, false},
    ...
    inline void HeapGraphNode_base::s_get_childsCount(v8::Local<v8::String> property, const v8::PropertyCallbackInfo<v8::Value> &args)
    {
        int32_t vr;
