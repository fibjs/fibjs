...
public:
    ...
    static result_t load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<TTYInputStream_base>& retVal);
...
inline result_t TTYInputStream_base::load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<TTYInputStream_base>& retVal)
{
    obj_ptr<TTYInputStream_base> vr;
