...
public:
    ...
    static result_t load(v8::Local<v8::Value> v, obj_ptr<BufferedStream_base>& retVal);
...
public:
    ...
    static void s_get_charset(const v8::FunctionCallbackInfo<v8::Value>& args);
    static void s_set_charset(const v8::FunctionCallbackInfo<v8::Value>& args);
    static void s_get_EOL(const v8::FunctionCallbackInfo<v8::Value>& args);
    static void s_set_EOL(const v8::FunctionCallbackInfo<v8::Value>& args);
...
inline result_t BufferedStream_base::load(v8::Local<v8::Value> v, obj_ptr<BufferedStream_base>& retVal)
{
    obj_ptr<BufferedStream_base> vr;
...
inline void BufferedStream_base::s_readText(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    ASYNC_METHOD_ENTER("BufferedStream.readText");
...
inline void BufferedStream_base::s_readLine(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    ASYNC_METHOD_INSTANCE(BufferedStream_base);
    ASYNC_METHOD_ENTER("BufferedStream.readLine");
...
inline void BufferedStream_base::s_readUntil(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    ASYNC_METHOD_INSTANCE(BufferedStream_base);
    ASYNC_METHOD_ENTER("BufferedStream.readUntil");
...
inline void BufferedStream_base::s_get_charset(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    exlib::string vr;
...
inline void BufferedStream_base::s_set_charset(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    METHOD_INSTANCE(BufferedStream_base);
    METHOD_ENTER();
...
inline void BufferedStream_base::s_get_EOL(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    exlib::string vr;
...
inline void BufferedStream_base::s_set_EOL(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    METHOD_INSTANCE(BufferedStream_base);
    METHOD_ENTER();
