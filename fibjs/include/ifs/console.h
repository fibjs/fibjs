...
public:
    ...
    static result_t log(exlib::string fmt, std::vector<v8::Local<v8::Value>>& args);
    static result_t log(std::vector<v8::Local<v8::Value>>& args);
    static result_t debug(exlib::string fmt, std::vector<v8::Local<v8::Value>>& args);
    static result_t debug(std::vector<v8::Local<v8::Value>>& args);
    static result_t info(exlib::string fmt, std::vector<v8::Local<v8::Value>>& args);
    static result_t info(std::vector<v8::Local<v8::Value>>& args);
    static result_t notice(exlib::string fmt, std::vector<v8::Local<v8::Value>>& args);
    static result_t notice(std::vector<v8::Local<v8::Value>>& args);
    static result_t warn(exlib::string fmt, std::vector<v8::Local<v8::Value>>& args);
    static result_t warn(std::vector<v8::Local<v8::Value>>& args);
    static result_t error(exlib::string fmt, std::vector<v8::Local<v8::Value>>& args);
    static result_t error(std::vector<v8::Local<v8::Value>>& args);
    static result_t crit(exlib::string fmt, std::vector<v8::Local<v8::Value>>& args);
    static result_t crit(std::vector<v8::Local<v8::Value>>& args);
    static result_t alert(exlib::string fmt, std::vector<v8::Local<v8::Value>>& args);
    static result_t alert(std::vector<v8::Local<v8::Value>>& args);
    ...
    static result_t print(exlib::string fmt, std::vector<v8::Local<v8::Value>>& args);
    static result_t print(std::vector<v8::Local<v8::Value>>& args);
