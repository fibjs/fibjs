...
public:
    ...
    static result_t load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<WebSocket_base>& retVal);
...
inline result_t WebSocket_base::load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<WebSocket_base>& retVal)
{
    obj_ptr<WebSocket_base> vr;
