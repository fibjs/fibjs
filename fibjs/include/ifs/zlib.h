...
inline ClassInfo& zlib_base::class_info()
{
    static ClassData::ClassMethod s_method[] = {
        { "createDeflate", s_static_createDeflate, true, false },
        { "createDeflateRaw", s_static_createDeflateRaw, true, false },
        { "createGunzip", s_static_createGunzip, true, false },
        { "createGzip", s_static_createGzip, true, false },
        { "createInflate", s_static_createInflate, true, false },
        { "createInflateRaw", s_static_createInflateRaw, true, false },
        { "deflate", s_static_deflate, true, true },
        { "deflateSync", s_static_deflate, true, false },
        { "deflateTo", s_static_deflateTo, true, true },
        { "deflateToSync", s_static_deflateTo, true, false },
        { "inflate", s_static_inflate, true, true },
        { "inflateSync", s_static_inflate, true, false },
        { "inflateTo", s_static_inflateTo, true, true },
        { "inflateToSync", s_static_inflateTo, true, false },
        { "gzip", s_static_gzip, true, true },
        { "gzipSync", s_static_gzip, true, false },
        { "gzipTo", s_static_gzipTo, true, true },
        { "gzipToSync", s_static_gzipTo, true, false },
        { "gunzip", s_static_gunzip, true, true },
        { "gunzipSync", s_static_gunzip, true, false },
        { "gunzipTo", s_static_gunzipTo, true, true },
        { "gunzipToSync", s_static_gunzipTo, true, false },
        { "deflateRaw", s_static_deflateRaw, true, true },
        { "deflateRawSync", s_static_deflateRaw, true, false },
        { "deflateRawTo", s_static_deflateRawTo, true, true },
        { "deflateRawToSync", s_static_deflateRawTo, true, false },
        { "inflateRaw", s_static_inflateRaw, true, true },
        { "inflateRawSync", s_static_inflateRaw, true, false },
        { "inflateRawTo", s_static_inflateRawTo, true, true },
