...
public:
    ...
    static result_t load(v8::Local<v8::Value> v, obj_ptr<TTYOutputStream_base>& retVal);
...
inline void TTYOutputStream_base::s__new(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    CONSTRUCT_INIT();
    __new(args);
}

inline void TTYOutputStream_base::__new(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    obj_ptr<TTYOutputStream_base> vr;
...
inline result_t TTYOutputStream_base::load(v8::Local<v8::Value> v, obj_ptr<TTYOutputStream_base>& retVal)
{
    obj_ptr<TTYOutputStream_base> vr;
