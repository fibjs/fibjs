...
public:
    ...
    static result_t load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<HttpRequest_base>& retVal);
...
inline result_t HttpRequest_base::load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<HttpRequest_base>& retVal)
{
    obj_ptr<HttpRequest_base> vr;
