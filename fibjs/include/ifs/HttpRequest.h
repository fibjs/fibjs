...
public:
    ...
    static result_t load(v8::Local<v8::Value> v, obj_ptr<HttpRequest_base>& retVal);
...
inline void HttpRequest_base::__new(const v8::FunctionCallbackInfo<v8::Value>& args)
{
...
inline result_t HttpRequest_base::load(v8::Local<v8::Value> v, obj_ptr<HttpRequest_base>& retVal)
{
    obj_ptr<HttpRequest_base> vr;
...
inline void HttpRequest_base::s_get_url(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    exlib::string vr;
