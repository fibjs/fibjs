...
public:
    ...
    static result_t sign(exlib::string algorithm, CryptoKey_base* key, Buffer_base* data, obj_ptr<Buffer_base>& retVal, AsyncEvent* ac);
...
public:
    ...
    ASYNC_STATICVALUE4(subtle_base, sign, exlib::string, CryptoKey_base*, Buffer_base*, obj_ptr<Buffer_base>);
