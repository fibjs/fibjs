...
public:
    ...
    static result_t resolve4(exlib::string host, obj_ptr<NArray>& retVal, AsyncEvent* ac);
    static result_t resolve6(exlib::string host, v8::Local<v8::Object> options, obj_ptr<NArray>& retVal, AsyncEvent* ac);
    static result_t resolve6(exlib::string host, obj_ptr<NArray>& retVal, AsyncEvent* ac);
    ...
    static result_t reverse(exlib::string ip, obj_ptr<NArray>& retVal, AsyncEvent* ac);
    static result_t cancel();
    static result_t setServers(v8::Local<v8::Array> servers, AsyncEvent* ac);
    static result_t getServers(obj_ptr<NArray>& retVal);
...
public:
    ...
    ASYNC_STATICVALUE2(dns_base, resolve4, exlib::string, obj_ptr<NArray>);
    ASYNC_STATICVALUE3(dns_base, resolve6, exlib::string, v8::Local<v8::Object>, obj_ptr<NArray>);
    ASYNC_STATICVALUE2(dns_base, resolve6, exlib::string, obj_ptr<NArray>);
    ...
    ASYNC_STATICVALUE2(dns_base, reverse, exlib::string, obj_ptr<NArray>);
    ASYNC_STATIC1(dns_base, setServers, v8::Local<v8::Array>);
...
inline ClassInfo& dns_base::class_info()
{
    static ClassData::ClassMethod s_method[] = {
        ...
        { "reverse", s_reverse, true },
        { "reverseSync", s_reverse, true },
        { "cancel", s_cancel, true },
        { "setServers", s_setServers, true },
        { "setServersSync", s_setServers, true },
        { "getServers", s_getServers, true },
...
inline void dns_base::s_reverse(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    obj_ptr<NArray> vr;

    METHOD_NAME("dns.reverse");
    METHOD_ENTER();
...
inline void dns_base::s_cancel(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    METHOD_NAME("dns.cancel");
    METHOD_ENTER();
...
inline void dns_base::s_setServers(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    METHOD_NAME("dns.setServers");
    METHOD_ENTER();
...
inline void dns_base::s_getServers(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    obj_ptr<NArray> vr;

    METHOD_NAME("dns.getServers");
    METHOD_ENTER();
