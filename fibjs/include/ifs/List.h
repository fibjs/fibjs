...
public:
    ...
    virtual result_t push(std::vector<v8::Local<v8::Value>>& els, int32_t& retVal) = 0;
    ...
    virtual result_t concat(std::vector<v8::Local<v8::Value>>& lists, obj_ptr<List_base>& retVal) = 0;
...
template <typename T>
void List_base::__new(const T& args)
{
