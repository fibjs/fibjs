...
{
    METHOD_NAME("RadosCluster.connect");
...
{
    METHOD_NAME("RadosCluster.createPool");
    METHOD_INSTANCE(RadosCluster_base);
    METHOD_ENTER();
...
{
    METHOD_NAME("RadosCluster.deletePool");
    METHOD_INSTANCE(RadosCluster_base);
    METHOD_ENTER();
...
inline void RadosCluster_base::s_createIoCtx(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    METHOD_NAME("RadosCluster.createIoCtx");
    METHOD_INSTANCE(RadosCluster_base);
    METHOD_ENTER();
...
{
    METHOD_NAME("RadosCluster.shutdown");
    METHOD_INSTANCE(RadosCluster_base);
    METHOD_ENTER();
