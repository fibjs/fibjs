...
public:
    ...
    static result_t load(v8::Local<v8::Value> v, obj_ptr<XmlNode_base>& retVal)
...
inline void XmlNode_base::s_replaceWith(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    METHOD_INSTANCE(XmlNode_base);
    METHOD_ENTER();
