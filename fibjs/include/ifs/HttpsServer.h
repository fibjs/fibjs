...
public:
    ...
    static result_t _new(SecureContext_base* context, Handler_base* hdlr, obj_ptr<HttpsServer_base>& retVal, v8::Local<v8::Object> This = v8::Local<v8::Object>());
...
public:
    ...
    static result_t load(v8::Local<v8::Value> v, obj_ptr<HttpsServer_base>& retVal);
...
inline void HttpsServer_base::s_setSecureContext(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    METHOD_INSTANCE(HttpsServer_base);
    METHOD_ENTER();
