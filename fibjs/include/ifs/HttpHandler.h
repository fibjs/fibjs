...
public:
    ...
    static result_t load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<HttpHandler_base>& retVal);
...
inline void HttpHandler_base::__new(const v8::FunctionCallbackInfo<v8::Value>& args)
{
...
inline result_t HttpHandler_base::load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<HttpHandler_base>& retVal)
{
    obj_ptr<HttpHandler_base> vr;
