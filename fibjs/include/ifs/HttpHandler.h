...
public:
    ...
    static result_t load(v8::Local<v8::Value> v, obj_ptr<HttpHandler_base>& retVal);
...
inline result_t HttpHandler_base::load(v8::Local<v8::Value> v, obj_ptr<HttpHandler_base>& retVal)
{
    obj_ptr<HttpHandler_base> vr;
