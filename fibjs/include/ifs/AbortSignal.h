...
public:
    ...
    static result_t load(v8::Local<v8::Value> v, obj_ptr<AbortSignal_base>& retVal)
...
inline void AbortSignal_base::s_static_timeout(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    obj_ptr<AbortSignal_base> vr;
