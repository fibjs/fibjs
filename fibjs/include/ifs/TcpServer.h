...
public:
    ...
    static result_t load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<TcpServer_base>& retVal);
...
inline result_t TcpServer_base::load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<TcpServer_base>& retVal)
{
    obj_ptr<TcpServer_base> vr;
