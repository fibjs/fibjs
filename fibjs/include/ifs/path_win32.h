...
public:
    ...
    static result_t load(Isolate* isolate, v8::Local<v8::Value> v, obj_ptr<path_win32_base>& retVal)
...
inline void path_win32_base::s_static_matchesGlob(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    bool vr;
...
inline void path_win32_base::s_static_get_sep(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    exlib::string vr;
...
inline void path_win32_base::s_static_get_delimiter(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    exlib::string vr;
...
inline void path_win32_base::s_static_get_posix(const v8::FunctionCallbackInfo<v8::Value>& args)
{
...
inline void path_win32_base::s_static_get_win32(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    v8::Local<v8::Object> vr;
