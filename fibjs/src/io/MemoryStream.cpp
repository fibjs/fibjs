...
{
    if (whence < fs_constants_base::__SEEK_SET || whence > fs_constants_base::__SEEK_END)
    ...
    if (whence == fs_constants_base::__SEEK_CUR)
        offset += p;
    else if (whence == fs_constants_base::__SEEK_END)
        offset += sz;
