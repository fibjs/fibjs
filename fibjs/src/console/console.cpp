...
void _log(int32_t type, exlib::string fmt, v8::Local<v8::Array> args)
{
    int32_t level;
...
void _log(int32_t type, v8::Local<v8::Array> args)
{
    int32_t level;
...
result_t console_base::log(exlib::string fmt, v8::Local<v8::Array> args)
{
    _log(_INFO, fmt, args);
    return 0;
}

result_t console_base::log(v8::Local<v8::Array> args)
{
    _log(_INFO, args);
    return 0;
}

result_t console_base::debug(exlib::string fmt, v8::Local<v8::Array> args)
{
    _log(_DEBUG, fmt, args);
    return 0;
}

result_t console_base::debug(v8::Local<v8::Array> args)
{
    _log(_DEBUG, args);
    return 0;
}

result_t console_base::info(exlib::string fmt, v8::Local<v8::Array> args)
{
    _log(_INFO, fmt, args);
    return 0;
}

result_t console_base::info(v8::Local<v8::Array> args)
{
    _log(_INFO, args);
    return 0;
}

result_t console_base::notice(exlib::string fmt, v8::Local<v8::Array> args)
{
    _log(_NOTICE, fmt, args);
    return 0;
}

result_t console_base::notice(v8::Local<v8::Array> args)
{
    _log(_NOTICE, args);
    return 0;
}

result_t console_base::warn(exlib::string fmt, v8::Local<v8::Array> args)
{
    _log(_WARN, fmt, args);
    return 0;
}

result_t console_base::warn(v8::Local<v8::Array> args)
{
    _log(_WARN, args);
    return 0;
}

result_t console_base::error(exlib::string fmt, v8::Local<v8::Array> args)
{
    _log(_ERROR, fmt, args);
    return 0;
}

result_t console_base::error(v8::Local<v8::Array> args)
{
    _log(_ERROR, args);
    return 0;
}

result_t console_base::crit(exlib::string fmt, v8::Local<v8::Array> args)
{
    _log(_CRIT, fmt, args);
    return 0;
}

result_t console_base::crit(v8::Local<v8::Array> args)
{
    _log(_CRIT, args);
    return 0;
}

result_t console_base::alert(exlib::string fmt, v8::Local<v8::Array> args)
{
    _log(_ALERT, fmt, args);
    return 0;
}

result_t console_base::alert(v8::Local<v8::Array> args)
{
    _log(_ALERT, args);
    return 0;
}
...
result_t console_base::print(exlib::string fmt, v8::Local<v8::Array> args)
{
    _log(_PRINT, fmt, args);
    return 0;
}

result_t console_base::print(v8::Local<v8::Array> args)
{
    _log(_PRINT, args);
    return 0;
}
