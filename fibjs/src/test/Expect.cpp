...
{
    return !m_not ? assert_base::ok(m_actual, m_msg.c_str()) :
                          ...
                          v8::Local<v8::Value> value)
{
    if (m_deep)
        return !m_not ?
               assert_base::deepPropertyVal(m_actual, prop, value, m_msg.c_str()) :
               assert_base::deepPropertyNotVal(m_actual, prop, value, m_msg.c_str());
