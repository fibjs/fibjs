...
result_t fs_base::open(exlib::string fname, exlib::string flags, int32_t& retVal, AsyncEvent* ac)
{
    if (!ac)
        return CHECK_ERROR(CALL_E_NOSYNC);
...
result_t fs_base::open(exlib::string fname, exlib::string flags, int32_t mod, int32_t& retVal, AsyncEvent* ac)
{
    if (!ac)
        return CHECK_ERROR(CALL_E_NOSYNC);
...
result_t fs_base::openSync(exlib::string fname, exlib::string flags, int32_t& retVal)
{
    return ac_open(fname, flags, retVal);
}

result_t fs_base::openSync(exlib::string fname, exlib::string flags, int32_t mod, int32_t& retVal)
{
    return ac_open(fname, flags, mod, retVal);
}
