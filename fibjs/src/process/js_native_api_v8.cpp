    ...
    napi_value* result)
{
    ...
    v8::MaybeLocal<v8::Array> maybe_all_propertynames = obj->GetPropertyNames(context,
        collection_mode,
        filter,
    ...
    napi_value* result)
{
    ...
    v8::Local<v8::Value> external_value = v8impl::ExternalWrapper::New(env, data);
    ...
    bool* result)
{
    ...
    CHECK_ARG(env, object);
    v8::Local<v8::Value> obj_val = v8impl::V8LocalValueFromJsValue(object);
    ...
    void** result)
{
    ...
    v8impl::ExternalWrapper* wrapper = v8impl::ExternalWrapper::From(external_value);
    *result = wrapper->Data();
