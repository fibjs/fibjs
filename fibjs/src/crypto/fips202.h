...
void sha3_256_inc_finalize(uint8_t* output, sha3_256incctx* state, uint8_t p = 0x06);
/* Copy the context */
...
/* Obtain the output of the function and free `state` */
void sha3_384_inc_finalize(uint8_t* output, sha3_384incctx* state, uint8_t p = 0x06);
/* Copy the context */
...
/* Obtain the output of the function and free `state` */
void sha3_512_inc_finalize(uint8_t* output, sha3_512incctx* state, uint8_t p = 0x06);
/* Copy the context */
