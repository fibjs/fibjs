...
fibjs is a runtime for javascript applictions built on google v8 JS.  Unlike node.js, fibjs uses fibers for parrallizing v8  engine. Through a large amoung of C++ compoments, heavy duty operations are performed in a background thread and the v8 thread is released. Thus fibjs, allows for greater concurrency 
## Online Docs
