...
docker image push fibjs/alpine-build-env:i386
docker image push fibjs/alpine-build-env:arm64
docker image push fibjs/alpine-build-env:arm
docker image push fibjs/alpine-build-env:ppc64

docker image push fibjs/alpine-test-env:amd64
docker image push fibjs/alpine-test-env:i386
docker image push fibjs/alpine-test-env:arm64
docker image push fibjs/alpine-test-env:arm
docker image push fibjs/alpine-test-env:ppc64
