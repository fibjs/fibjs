...
docker build --rm -f alpine-build-env.i386 -t fibjs/alpine-build-env:i386 .
docker build --rm -f alpine-build-env.arm64 -t fibjs/alpine-build-env:arm64 .
docker build --rm -f alpine-build-env.arm -t fibjs/alpine-build-env:arm .
...
docker build --rm -f alpine-test-env.i386 -t fibjs/alpine-test-env:i386 .
docker build --rm -f alpine-test-env.arm64 -t fibjs/alpine-test-env:arm64 .
docker build --rm -f alpine-test-env.arm -t fibjs/alpine-test-env:arm .
